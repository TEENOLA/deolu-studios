    ...
    <section id="about" className="section-pad relative">
      <div className="container-page">
        <Reveal className="mx-auto max-w-2xl text-center">
          <p className="eyebrow">Why deolustudios</p>
          <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl">
            Websites built with intention, not templates
          </h2>
          <p className="mt-4 text-mist-400">
            We're a small studio that treats every project like it's the only one —
            collaborative, detail-obsessed, and focused on results you can measure.
          </p>
        </Reveal>
            ...
            return (
              <Reveal key={item.id} delay={i * 80}>
                <div className="card-surface group h-full p-7 transition-all duration-300 hover:border-brand-blue/30 hover:bg-white/[0.035]">
                  ...
                  <h3 className="mt-5 text-lg font-semibold text-mist-50">{item.title}</h3>
